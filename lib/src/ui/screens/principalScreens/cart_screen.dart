                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text('Preu total', style:TextStyle(color: AppColors.secondary, fontSize: 20),),
                        Text(
                            ' ${context.select((NavigationNotifier c) => c.total)}€',style:TextStyle(color: AppColors.secondary, fontSize: 20)
                        )
                      ],
                    ),
                  ),
